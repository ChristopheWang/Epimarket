...
<f:loadBundle basename="message" var="message"/>
	<html>
	    ...
	    <body>
	    	...
	    	<x:htmlTag value="br"/>
	    	<x:htmlTag value="br"/>
	    	<h3><h:outputText value="#{message.register}"/></h3>
	        <h:form id="InfoForm">
       		<h:outputText value="Vos informations personnelles :"/>
       		<x:htmlTag value="br"/>
       		<x:htmlTag value="br"/>
       		<h:panelGrid columns="3">
       			<h:outputText value="Votre identifiant :"/>
       		...
       		<x:htmlTag value="br"/>
       		<h:commandButton value="Valider" action="#{clientBean.validationForm}" />
       		<h:commandButton value="Annuler" action="index" immediate="true"/>
          	</h:form>
          	<x:htmlTag value="br"/>
			<x:htmlTag value="br"/>
			<h:graphicImage value="includes/css/images/separateur.png" />
