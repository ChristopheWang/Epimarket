...
<f:loadBundle basename="message" var="message"/>
	<html>
	    <head>           
	        <title>Modifications réussies</title>
	    ...
	    <body>
	        ...
	        <x:htmlTag value="br"/>
      		...
      		<h:outputText value="Votre téléphone : "/><h:outputText value="#{clientBean.clientEditBean.currentClient.phone}"/>
       		...
       		<x:htmlTag value="br"/>
           	<h:commandButton value="Modifier à nouveau" action="editProfile"/>
           	<h:commandButton value="Retourner à la page principale" action="main"/>
	        </h:form>
	      	<x:htmlTag value="br"/>
			<x:htmlTag value="br"/>
			<h:graphicImage value="includes/css/images/separateur.png" />
